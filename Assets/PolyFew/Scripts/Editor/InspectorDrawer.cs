...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v5.7</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                ...
                if (GUILayout.Button(content, style, GUILayout.Width(20), GUILayout.Height(20)))
                {
...
#pragma warning disable
        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            content = new GUIContent();
            content.text = "<size=13><b><color=#A52A2AFF>BATCH FEW</color></b></size> <size=7><b><color=#A52A2AFF>v1.7</color></b></size>";
            ...
            if (FoldoutBatchFew)
            {
                ...
                content = new GUIContent();
                content.text = "<size=11><color=#000000><b>Convert Skinned Meshes</b></color></size>";
